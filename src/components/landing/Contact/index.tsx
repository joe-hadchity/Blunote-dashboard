...
const Contact = () => {
  ...
  return (
    <>
      {/* <!-- ===== Contact Start ===== --> */}
      <section id="support" className="py-16 lg:py-20 xl:py-24 bg-gray-50 dark:bg-gray-900">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
           <SectionHeader
  headerInfo={{
    title: "CONTACT US",
    subtitle: "Get in Touch",
    description: "Have questions or need support? We're here to help you get the most out of Bluenote.",
  }}
/>
...
>
  ...
  <div className="mb-7">
    ...
    <p>
      <a href="mailto:support@yourdomain.com" className="text-primary dark:text-primary">
