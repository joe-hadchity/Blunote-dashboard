  ...
  return (
    <>
      <footer className="border-t border-stroke bg-white dark:border-strokedark dark:bg-blacksection">
        <div className="mx-auto max-w-none px-16 sm:px-20 lg:px-24">
          {/* <!-- Footer Top --> */}
          <div className="py-16 lg:py-20">
            <div className="flex flex-wrap gap-8 lg:justify-between lg:gap-0">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="animate_top lg:w-1/2"
              >
          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            ...
            >
              <ul className="flex items-center gap-8">
                ...
                <li>
                  <a href="mailto:support@bluenote.ai" className="hover:text-primary">
                    Support
                  </a>
                </li>
              </ul>
            ...
            >
              <p>
                &copy; {new Date().getFullYear()} Bluenote. All rights reserved
              </p>
            </motion.div>
