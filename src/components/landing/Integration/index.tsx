...
const Integration = () => {
  return (
    <>
      <section id="integration" className="py-16 lg:py-20 xl:py-24 bg-gray-50 dark:bg-gray-900">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <SectionHeader
            headerInfo={{
              ...
              description: `Integrates smoothly with your favorite meeting and collaboration tools, letting you enjoy clear audio and live captions effortlessly.`,
            }}
          />
        ...
        <div className="pattern-dots pattern-blue-500 pattern-bg-white pattern-size-4 pattern-opacity-10 relative z-50 mx-auto mt-12 max-w-6xl px-4 sm:px-6 lg:px-8 xl:mt-16">
